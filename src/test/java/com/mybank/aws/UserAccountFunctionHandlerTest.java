 ...
 */
public class UserAccountFunctionHandlerTest {
    ...
    @Test
    public void testUserAccountFunctionHandler() {
        UserAccountFunctionHandler handler = new UserAccountFunctionHandler();
