 ...
 */
public class UserCognitoSignoutFunctionHandlerTest {
    ...
    @Test
    public void testUserCognitoSignoutFunctionHandler() {
        UserCognitoSignoutFunctionHandler handler = new UserCognitoSignoutFunctionHandler();
