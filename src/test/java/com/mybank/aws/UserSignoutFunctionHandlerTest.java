 ...
 */
public class UserSignoutFunctionHandlerTest {
    ...
    @Test
    public void testUserSignoutFunctionHandler() {
        UserSignoutFunctionHandler handler = new UserSignoutFunctionHandler();
